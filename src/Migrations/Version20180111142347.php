 ...
 */
class Version20180111142347 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE user_admin CHANGE password password VARCHAR(50) NOT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE user_admin CHANGE password password VARCHAR(500) NOT NULL COLLATE utf8_unicode_ci');
    }
}
