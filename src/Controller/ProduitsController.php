    ...
    extends Controller
{
   ...
   public function kit (Request $objetRequest, Connection $objetConnection)
   {
        ...
        require_once("$cheminTemplates/template-boutique-kit.php");
   ...
   public function kitFiche (\App\Entity\Kits $objetKits, Request $objetRequest, Connection $objetConnection) 
   {
        ...
        $cheminTemplates = "$cheminSymfony/templates"; 
        $cheminPart      = "$cheminTemplates/part"; 
        require_once("$cheminTemplates/template-boutique-kit-fiche.php");
   ...
   public function pictogramme (Request $objetRequest, Connection $objetConnection)
   {
        ...
        $cheminTemplates = "$cheminSymfony/templates"; 
        $cheminPart      = "$cheminTemplates/part"; 
        require_once("$cheminTemplates/template-boutique-pictogramme.php");
   ...
   public function pictoFiche (\App\Entity\Pictogrammes $objetPictogramme, Request $objetRequest, Connection $objetConnection)
   {
        ...
        $cheminTemplates = "$cheminSymfony/templates"; 
        $cheminPart      = "$cheminTemplates/part"; 
        require_once("$cheminTemplates/template-boutique-picto-fiche.php");
   ...
   /**
      ...
      */   
   public function panier (Request $objetRequest, Connection $objetConnection)
   {
        // POUR RECUPERER LES INFOS DE FORMULAIRE
        // ON DEMANDE A SYMFONY DE NOUS FOURNIR 
        // UN OBJET DE LA CLASSE Request
        ...
        $cheminTemplates = "$cheminSymfony/templates"; 
        $cheminPart      = "$cheminTemplates/part"; 
        require_once("$cheminTemplates/template-panier.php");
   ...
   /**
      * @Route("cheminAchat/", name="cheminAchat")
      */   
   public function cheminAchat (Request $objetRequest, Connection $objetConnection)
   {
        // POUR RECUPERER LES INFOS DE FORMULAIRE
        // ON DEMANDE A SYMFONY DE NOUS FOURNIR 
        // UN OBJET DE LA CLASSE Request
        ...
        $cheminTemplates = "$cheminSymfony/templates"; 
        $cheminPart      = "$cheminTemplates/part"; 
        require_once("$cheminTemplates/template-chemin-achat.php");
