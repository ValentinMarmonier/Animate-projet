    ...
    extends Controller
{
   ...
   /**
      * @Route("cgu/", name="cgu")
      */   
   public function cgu (Request $objetRequest, Connection $objetConnection, SessionInterface $objetSession)
   {
        ...
        $cheminTemplates = "$cheminSymfony/templates"; 
        $cheminPart      = "$cheminTemplates/part"; 
        require_once("$cheminTemplates/template-cgu.php");
   ...
   /**
      * @Route("infosLegales/", name="infosLegales")
      */   
   public function infosLegales (Request $objetRequest, Connection $objetConnection, SessionInterface $objetSession)
   {
        ...
        $cheminTemplates = "$cheminSymfony/templates"; 
        $cheminPart      = "$cheminTemplates/part"; 
        require_once("$cheminTemplates/template-infos-legales.php");
